<template src="./AddAlipay.html"></template>
...
export default {
  ...
  data() {
    return {
      addAlipaydData: [
        { listName: "用户姓名", placeholder: "请输入姓名", value: "" },
        { listName: "支付宝帐号", placeholder: "请输入支付宝帐号", value: "" },
  ...
  methods: {
    ...
    submit() {
      this.insertData.name = this.addAlipaydData[0].value;
      this.insertData.no = this.addAlipaydData[1].value;
...
<style lang="scss" src="./AddAlipay.scss" scoped></style>
